...
class EditBasketCell: UITableViewCell {
...
//        button.backgroundColor = .systemBlue
        button.setImage(R.image.notSelectIcon(), for: .normal)
        button.setImage(R.image.selectedIcon(), for: .selected)
    ...
    private func setupConstraints() {
        ...
        selectButton.snp.makeConstraints { make in
            ...
            //make.right.equalTo(viewContent.snp.left)
        }
        
        viewContent.snp.makeConstraints { make in
            //            make.edges.equalToSuperview()
            make.top.right.equalToSuperview()
            make.left.equalTo(selectButton.snp.right).offset(8)
            make.bottom.equalToSuperview().offset(-8)
        }
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        selectButton.removeTarget(self, action: #selector(selectButtonPressed), for: .touchUpInside)
